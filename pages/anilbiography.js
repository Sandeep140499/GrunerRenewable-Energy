...
{/* <div className="hide">1234567890</div> */}
  ...
  <div class="container p-0">
    ...
    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/2c42122fb1da9e4fc0a561fe4dba8096.jpg" class="img-fluid" alt="..."/>
</div>
  <div class="col-12 col-lg-9 p-3 pt-lg-2 text-center">
  <h1 className='pt-lg-5 biopageheader'>Anil Dhussa</h1>
    <h2 className='pt-lg-3 biographyheader2'>(Chief Advisor)</h2>
</div>
<div class="col-lg-12 col-12  p-3 biographylorem">
<p>Anil Dhussa is a celebrated name in the biogas industry across the world. He is a Chemical Engineer from the famed Indian Institute of Technology, Roorkee, and has been serving in the biogas sector since 1978. With an experience spanning over four decades, Mr. Dhussa understands all the nitty-gritties of the biogas industry and has made significant contributions to the growth and development of biogas programs in India and around the world. He is an author of over fifty publications on biogas that include books, manuals, and peer-reviewed papers. His contributions have been instrumental in driving the growth of the biogas sector in India and across the world.</p>

    <p  className='biographyheader2'>Mr. Dhussa played a key role in developing national policies and programs for biogas, waste-to-energy, and biofuels in India. His efforts in supporting research and development and setting up large-scale biogas-based waste-to-energy projects for a variety of feedstocks have been instrumental in the growth of the biogas sector in India.</p>

  <p  className='biographyheader2'>Mr. Dhussa began his journey in the biogas sector with research and development and design of household size biogas plants. His work on the National Biogas Programme in India has been instrumental in the installation of millions of biogas plants in rural households across the country. His work in leadership roles in the Ministry of New and Renewable Energy (MNRE) of the Government of India on National Programs on Biogas, Waste-to-Energy, and Biofuels has been a major catalyst in driving the biogas sector forward.</p>
  <p  className='biographyheader2'>His vision for the biogas sector has always been focused on sustainable waste management and the production of renewable energy. He has carried out evaluations of biogas programs of the Netherlands Development Organisation in Nepal and Indonesia and co-chaired the Biogas Sub-Committee of the Global Methane Initiative, an international partnership supported by the USEPA for five years</p>
  <p  className='biographyheader2'>After retiring from the Government of India, Mr. Dhussa continued his work in the biogas sector as a consultant for major international organisations. He has worked on consulting assignments with the World Bank-aided project on setting up large-sized biogas plants in Nepal, among others. </p>
</div>
    </div>
</div>
  {/* code end from here  */}

...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/galleryDetails');
    ...
    <div className="container">
      <div className="row pt-5">
        <div className="col-12 text-center">
          <span className=" gallarydetails p-lg-2 ">GALLERY</span>
          <h1 className="projectHeading pt-5">Bio - Fuel</h1>
        </div>
        <div className="col-12 col-lg-6 ">
          <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/gallery frame.jpg" alt="img-fluid" srcSet className="col-12 col-lg-12" />
        </div>

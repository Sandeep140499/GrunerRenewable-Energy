...
export async function getServerSideProps() {
  const [operationsRes,bannerRes,whatsappRes,videoRes] = await Promise.all([
    ...
    fetch(`https://whale-app-56hrz.ondigitalocean.app/api/gallery-videos/?populate=*`)
    // fetch(`http://localhost:1337/api/careers/?populate=*`)
  ]);
  const [operations,banner,whatsapp,video] = await Promise.all([
    operationsRes.json(),
    bannerRes.json(),
    whatsappRes.json(),
    videoRes.json()
  ]);
  return { props: { operations,banner,whatsapp,video} };
}
export default function Home({operations,banner,whatsapp,video}) {
...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/gallery');
...
{/* <div className="hide">1234567890</div> */}
  ...
  <div className="container ">
    ...
    {/* videos code start from here  */}
    <div>
    <div className='text-center pb-5'>
          <span className="sluggallery ">VIDEOS</span>
          </div>
    </div>
    {/* videos code  end from here  */}
  </div>
</div>
<div class="container overflow-hidden">
  <div class="row pb-5">
  {video.data?.map( (row) => (
    <div class="col-12 col-lg-4 pt-lg-3 gallaryvideopadding">
     <div class="">
      
     <div className="embed-responsive embed-responsive-16by9">
  <iframe className="embed-responsive-item" src={row?.attributes.video_url} height={200} width={400} allowfullscreen></iframe>
</div>
     </div>
    </div>
    ))}
    {/* <div class="col-12 col-lg-6 gallaryvideopadding">
      <div class="">
      <div className="embed-responsive embed-responsive-16by9">
  <iframe className="embed-responsive-item" src="https://player.vimeo.com/video/137857207" height={200} width={400} allowfullscreen></iframe>
</div>
        </div>
    </div> */}
  </div>

...
export async function getServerSideProps() {
  const [operationsRes,bannerRes,whatsappRes] = await Promise.all([
    ...
    fetch(`https://whale-app-56hrz.ondigitalocean.app/api/blogs-banners/?populate=*`),
...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/blogs');
...
{banner.data?.map( (row) => (
  <section id="Blogs" className="d-flex align-items-center">
    <div className="container">
      <h1>{row?.attributes.banner_title}</h1>
      <ReactMarkdown>
  ...
  {/* <div className="row">
    <div className="col-12 ">
      <div className="navs">
        <a className="navs active">View All</a>
        <a className="navs">Bio Gas</a>
        <a className="navs">Renewable Energy</a>
        <a className="navs">Sustainability</a>
      </div>     
    </div>
  </div> */}
  {/* <hr /> */}
  ...
  {operations.data?.map( (row) => (
    <div className="col-12 col-lg-6 p-lg-5">
      <div className="cardsImagesPadding">
        <img src={ row?.attributes.image.data[0].attributes.url} className="card-img-top" alt="..." />
        <div className="card-body pt-3">
          <h5 className="card-title pt-3">{row?.attributes.title}
          </h5>
          <ReactMarkdown className="card-text pt-3">{row?.attributes.description}</ReactMarkdown>
         <a href={`/blogs/${row?.attributes.Slug}`}> <button className="blogsbuttonreadmore">Read More  <i className="bi bi-arrow-right-short mx-2" /></button></a>
        </div>
      </div>
    </div>
    ))}
  ...
  {/* <div className="row pt-2">
    <div className="col-12 col-lg-6 ">
      <div className="cardsImagesPadding">
        <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/blogs 5.jpeg" className="card-img-top" alt="..." />
        <div className="card-body">
          <h5 className="card-title">Lorem ipsum has been industries</h5>
          <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
          <button>Read More<i className="bi bi-arrow-right-short" /></button>
        </div>
      </div>
    </div>
    <div className="col-12 col-lg-6">
      <div className="cardsImagesPadding">
        <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/blogs 6.jpeg" className="card-img-top" alt="..." />
        <div className="card-body">
          <h5 className="card-title">Lorem ipsum has been industries</h5>
          <p className="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
          <button>Read More<i className="bi bi-arrow-right-short" /></button>

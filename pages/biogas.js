...
export async function getServerSideProps() {
  const [operationsRes,biogasRes,cngsRes,logoRes,teamRes] = await Promise.all([
  ...
  const [operations,biogas,cngs,logos,team] = await Promise.all([
    operationsRes.json(),
    biogasRes.json(),
    cngsRes.json(),
    logoRes.json(),
  ...
  return { props: { operations,biogas,cngs,logos,team} };
}
export default function Home({operations,biogas,cngs,logos,team}) {
  return (
    <>
      <Head>
 ...
 <div>
  ...
  <section id="herobiogas" className="d-flex align-items-center">
  ...
  <div className="container-fluid" id="frame-2">
    <div className="row pt-lg-5">
      <div className="col-12 col-lg-4 my-auto mx-auto p-lg-5">
        <h1 className="heading-frame-third ">{row?.attributes.bio_gas_left_title}</h1>
        <br />
        <ReactMarkdown className="paragraph-lorem-2 pt-5">
          {row?.attributes.bio_gas_left_desription}
        </ReactMarkdown>
      </div>
      <div className="col-12 col-lg-5">
        <img src={ row?.attributes.bio_gas_image.data[0].attributes.url} className="img-fluid" alt="..." id />
        {/* <img
      ...
      <ReactMarkdown>
          {row?.attributes.bio_right_desription}
          </ReactMarkdown>
        <div className="row bayehojaa">
          <div className="col-12 ">
            <div className="p-3">
              <i className="bi bi-check2-circle" id="sign">
                <span id="kuchbhidedo">{row?.attributes.bio_right_bottom1}</span>
              </i>
            </div>
          </div>
          <div className="col-12">
            <div className="p-3"><i className="bi bi-check2-circle" id="sign">                    <span id="kuchbhidedo">{row?.attributes.bio_right_bottom2}</span>
              </i></div>
          </div>
          <div className="col-12">
            <div className="p-3"><i className="bi bi-check2-circle" id="sign">                    <span id="kuchbhidedo">{row?.attributes.bio_right_bottom3}</span>
              </i></div>
          </div>
          <div className="col-12">
            <div className="p-3"><i className="bi bi-check2-circle" id="sign">                    <span id="kuchbhidedo">{row?.attributes.bio_right_bottom4}</span>
              </i></div>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="row">
          <div className="col-12 col-lg-6 my-2">
            <span className="biospan p-lg-2 ">BIO - GAS</span>
            <h1 className="headingenergy pt-lg-3 pb-1 pt-3">{row?.attributes.description}</h1>
            <ReactMarkdown className="biogaspara  pb-lg-0">
          ...
          <div className="col-12 col-lg-6 ">
            <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/plantsetup2.png" alt  className='plantsetup2 img-fluid'/>
  ...
  {cngs.data?.map( (row) => (
   ...
   <section className=" hero">
     <div className="row">
       ...
       <div className="col-12 col-lg-6 p-lg-5 p-5 pt-lg-5">
  ...
  <div className="container biogasconatiner">
  {operations.data?.map( (row) => (
    <div className="row">
      <div className="row col-12 col-lg-6">
        <div className="col-12 col-lg-12 my-5 biogasrespon">
          <span className="emergyspan  p-lg-2">BIO - GAS</span>
          <h1 className="headingenergy my-2">{row?.attributes.bio_fuel_left_title}</h1>
          <ReactMarkdown className="biogaswalepagekebootankeniche my-5 pt-5">{row?.attributes.bio_fuel_left_description}</ReactMarkdown>
          <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/bio-fuel.jpg" alt className=' img-fluid pt-5'/>
        </div>
      </div>
      <div className="col-12 col-lg-5 mx-auto p-lg-5">
     
        
  <div>
    <h1 className="biogaspageheading">
      {" "}
      <i className="bi bi-arrow-return-right renewablearrow p-lg-2" /> {row?.attributes.bio_fuel_right_title1}
      :
    </h1>
    <ReactMarkdown className="biogaspageparagraph mx-5">
    {row?.attributes.bio_fuel_right_description1}
    </ReactMarkdown>
  </div>
  ...
  <div>
    ...
    <h1 className="biogaspageheading">
      {" "}
      <i className="bi bi-arrow-return-right renewablearrow p-lg-2" />
      {row?.attributes.bio_fuel_right_title2} :
    </h1>
    <ReactMarkdown className="biogaspageparagraph mx-5">
    {row?.attributes.bio_fuel_right_description2}
    </ReactMarkdown>
  </div>
  <div>
    <h1 className="biogaspageheading">
      {" "}
      <i className="bi bi-arrow-return-right renewablearrow p-lg-2" />
      {row?.attributes.bio_fuel_right_title3} :
    </h1>
    <ReactMarkdown className="biogaspageparagraph mx-5">
    {row?.attributes.bio_fuel_right_description3}
    </ReactMarkdown>
  </div>
  <div>
    <h1 className="biogaspageheading">
      {" "}
      <i className="bi bi-arrow-return-right renewablearrow p-lg-2" />
      {row?.attributes.bio_fuel_right_title4} :
    </h1>
    <ReactMarkdown className="biogaspageparagraph mx-5">
    {row?.attributes.bio_fuel_right_description4}
    </ReactMarkdown>
  </div>
  <div>
    <h1 className="biogaspageheading">
      {" "}
      <i className="bi bi-arrow-return-right renewablearrow p-lg-2" />
      {row?.attributes.bio_fuel_right_title5}
    :
    </h1>
    <ReactMarkdown className="biogaspageparagraph mx-5">
    {row?.attributes.bio_fuel_right_description5}
    </ReactMarkdown>
  </div>
  <div>
    <h1 className="biogaspageheading">
      {" "}
      <i className="bi bi-arrow-return-right renewablearrow p-lg-2" />
      {row?.attributes.bio_fuel_right_title6}
     :
    </h1>
    <ReactMarkdown className="biogaspageparagraph mx-5">
    {row?.attributes.bio_fuel_right_description6}
    </ReactMarkdown>
  </div>
</div>
    </div>
    ...
    {/* IMAGES PART  crowser part*/}
    <div className="container p-0 ">
      <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img className="d-block w-100" src="https://gremedia.sgp1.digitaloceanspaces.com/media/middle.jpeg" alt="First slide" />
          </div>
    ...
    <div className="container p-lg-4">
      <div className="row">
        {/* <div className="col-12 col-lg-12">
          <span className="mission p-lg-2">MEET OUR EXPERT</span>
        </div> */}
        {/* <div className="col-12 col-lg-12 mt-5 addYourTextHeading">
          <h1>Add Your Heading Text <br />Here</h1>
        </div> */}
            ...
            {team.data?.map( (row) => (
              ...
              {/* <div className="col-md-3">
                <div className="thumbnail">
                  <a href>
                    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle-144 (1).jpg" alt="Nature" style={{"width":"100%"}} />
                    <div className="caption-baground">
              ...
              <div className="col-md-3">
                <div className="thumbnail">
                  <a href>
                    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle-144 (2).jpg" alt="Fjords" style={{"width":"100%"}} />
                    <div className="caption-baground">
                      <h1 className="girishBansal-heading">Mr. Girish Bansal</h1>
                      <p className="Designation">Designation</p>
                    </div>
              ...
              <div className="col-md-3">
                <div className="thumbnail">
                  <a href>
                    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle-144 (3).jpg" alt="Fjords" style={{"width":"100%"}} />
                    <div className="caption-baground">
                      <h1 className="girishBansal-heading">Mr. Girish Bansal</h1>
                      <p className="Designation">Designation</p>
                    </div>
    ...
    {/* frame 5 logo section end............................................. */}
    {/* crowser part start here*/}
    {/* crowser section */}
    {/* crowser part start here*/}
    {/* biogas three images start here  */}
    {/* <div class="container text-center">
  <div class="row ">
    <div class="col-12 col-lg-12 my-5">
<span class="projectspan p-lg-2 text-center">PROJECTS</span>
<h1 class="projectHeading pt-5">Latest Projects, Solutions And <br/> Energy Supplies</h1>
<div class="container">
  <div class="row g-2 p-lg-4">
    <div class="col-4">
      <div class="p-3 ">image section</div>
    </div>
    <div class="col-4">
      <div class="p-3 ">image section</div>
    </div>
    ...
    <div className="container p-0">
      <div className="container pb-3">
        <div className="row pt-5">
          <div className="col-12 text-center">
            <span className="emergyspan p-lg-2 ">PROJECTS</span>
            <h1 className="projectHeading pt-5">Latest Projects, Solutions And Energy <br /> Supplies</h1>
          </div>
      ...
      {/* frame graph end */}
      {/* biogas three images end here  */}
      {/* form start here */}
      {/* <div class="row g-0 ">
  <div class="col-sm-6 col-md-4 getintouchbackgroundcolor p-lg-5 ">
    <span class="getintouchspan my-5 p-lg-2">GET IN TOUCH</span>
    <h1 class="getintouchheading my-5">Let's Start Project With Our Company & Booking Now !</h1>
    <p class="getintouchpara">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
  </div>
  <div class="col-6 col-md-6"> contact form////
  </div>
</div> */}
     {/* form start here */}

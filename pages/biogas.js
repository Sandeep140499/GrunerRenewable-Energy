...
export async function getServerSideProps() {
  const [operationsRes,biogasRes,cngsRes,logoRes,teamRes,productRes] = await Promise.all([
  ...
  const [operations,biogas,cngs,logos,team,product] = await Promise.all([
    operationsRes.json(),
    biogasRes.json(),
    cngsRes.json(),
    logoRes.json(),
  ...
  return { props: { operations,biogas,cngs,logos,team,product} };
}
export default function Home({operations,biogas,cngs,logos,team,product}) {
  return (
    <>
      <Head>
      ...
      <ReactMarkdown>
        ...
        <div className="row bayehojaa">
          <div className="col-12 ">
            <div className="p-3">
              <i className="bi bi-check2-circle" id="sign"> <span     id="kuchbhidedo">{row?.attributes.bio_right_bottom1}</span>
              </i>
            </div>
          </div>
          <div className="col-12">
     ...
     <div className="row">
       <div className="col-12 col-lg-6">
         <div className="container text-center ">
           ...
           <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/Untitled-1.png" alt className="indiaMAP img-fluid" />
         </div>
       </div>
    ...
    <div className="row">
      <div className="row col-12 col-lg-6">
        <div className="col-12 col-lg-12 my-5 biogasrespon">
          ...
          <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/biogasplant.png" alt className=' img-fluid pt-5'/>
        </div>
      </div>
              ...
              <div className="col-12 col-lg-4">
                <div className="p-3 ">
                  <div className="containerImages">
                    ...
                    <div className="contentParagraph p-lg-3">
                      <ReactMarkdown className="ourprojectparagraph p-3 pt-lg-5 p-lg-0"></ReactMarkdown>

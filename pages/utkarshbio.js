...
{/* <div className="hide">1234567890</div> */}
  ...
  <div class="container p-0">
    ...
    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/76fef8c6957f57dfe5fc1c75383ed6c9.jpg" class="img-fluid" alt="..."/>
</div>
  <div class="col-12 col-lg-9 p-3 pt-lg-5 text-center">
  <h1 className=' biopageheader'>Utkarsh Gupta</h1>
    <h2 className='pt-lg-3 biographyheader2'>(Founder and CEO)</h2>
</div>

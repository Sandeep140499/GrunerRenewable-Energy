...
export async function getServerSideProps() {
  const [operationsRes,sustainabilityRes,blogRes] = await Promise.all([
  ...
  const [operations,sustainability,blog] = await Promise.all([
    operationsRes.json(),
    sustainabilityRes.json(),
    blogRes.json()
  ]);
  return { props: { operations,sustainability,blog} };
}
export default function Home({operations,sustainability,blog}) {
  return (
    <>
      <Head>

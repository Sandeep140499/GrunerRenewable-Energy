...
export async function getServerSideProps() {
  const [operationsRes, bannerRes,whatsappRes] = await Promise.all([
    ...
    fetch(`https://whale-app-56hrz.ondigitalocean.app/api/product-banners/?populate=*`),
...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/project');
...
{/* <div className="hide">1234567890</div> */}
 ...
 {banner.data?.map( (row) => (
  <section id="hero-our-project" className="d-flex align-items-center">
    ...
    <div className="container">
      <div className="row pt-5">
        <div className="col-12 text-center">
          <span className="text-center projectspandeiv emergyspan p-lg-2 ">PROJECTS</span>
          <h1 className="projectHeading pt-5">Latest Projects, Solutions And Energy Supplies</h1>
        </div>
              ...
              <div className="col-12 col-lg-4">
                <div className="p-3">
                  <div className="containerImages">
                    ...
                    <div className="contentParagraph p-lg-2">
                      <ReactMarkdown className="ourprojectparagraph text-start pt-5 pr-5">{row?.attributes.description}</ReactMarkdown>
                     <a href={`/projectdetails/${row?.attributes.Slug}`}> <button className=" btn-secondary exploremorebutton ">EXPLORE <i className="bi bi-arrow-right" /></button></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* <div className="col-12 col-lg-4">
                <div className="p-3 ">
                  <div className="containerImages">
                    ...
                    <div className="contentParagraph p-lg-2">
                      <p className="ourprojectparagraph text-start pt-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
        ...
        <div className="p-lg-5 text-center pt-3 pb-3">
          <button type="button" className="btn viewmorebutton">View More <i className="bi bi-plus-lg" /></button>
        </div>
      </div>
    </div>

...
export const Slug = ({product,programs}) => {
    ...
    programs.data.map(row=>{
      if(row.attributes.Slug == query.Slug){
          ...
          row.attributes.gallery_image.data?.map(image=>{
...
<div class="col-12 col-lg-12 my-5">
  <span class="projectspan p-lg-2 text-center">GALLERY</span>
  <h1 class="projectHeading pt-5">Bio - Fuel</h1>
    </div>
   </div> */}
  ...
  <div className="container-fluid p-0">
    <div className="container">
      <div className="row pt-5">
        ...
        <span className="projectspan p-lg-2 ">GALLERY</span>
          <h1 className="projectHeading pt-5">{product.attributes.gallery_name}</h1>
        </div> */}
         <div className="col-12 text-center">
          <div>
          <span className="sluggallery ">GALLERY</span>
          </div>
          <h1 className="projectHeading pt-5">{product.attributes.gallery_name}</h1>
        </div>
        <div className="col-12 col-lg-6 ">
        {courseimage.map( (row) => (
          <img src={ row?.attributes.url} alt="img-fluid" srcSet className="col-12 col-lg-12" />
          ))} 
        </div>
          ...
          <div className="row g-2">
            <div className="col-6">
              <div className=" border bg-light">
                <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/gallaryimage1.jpg" alt="img-fluid" srcSet className="col-12 col-lg-12" />
              </div>
            </div>
            <div className="col-6">
              <div className=" border bg-light">
                <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/gallaryimage2.jpg" alt="img-fluid" srcSet className="col-12 col-lg-12" />
              </div>
            </div>
            <div className="col-12">
              <div className=" border bg-light">
                <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/gallaryimage3.jpg" alt="img-fluid" srcSet className="col-12 col-lg-12" />
              </div>
            </div>
          </div>
        </div> */}
...
export async function getServerSideProps(context) {
    const [productRes,programsRes] = await Promise.all([
        fetch(`https://whale-app-56hrz.ondigitalocean.app/api/galleries/?filters[Slug]=` + context.query.Slug ),

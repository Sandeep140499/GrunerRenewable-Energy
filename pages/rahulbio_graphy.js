...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/rahulbio_graphy');
...
{/* <div className="hide">1234567890</div> */}
  ...
  <div class="container p-0">
    ...
    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/Frame%201%20(2).png" class="img-fluid" alt="..."/>
</div>
  <div class="col-12 col-lg-9 p-3 pt-lg-5 text-center">
  <h1 className='pt-lg-5 biopageheader'>Rahul Rustagi</h1>
    <h2 className='pt-lg-3 biographyheader2'>(Co-Founder, CFO and Head of International Sales)</h2>
</div>
...
<p>Rahul Rustagi, is a highly qualified professional who boasts of a bouquet of prestigious degrees such as CA-CS-CWA-CPA(AUS)-CMA(UK). He has had an enviable career spanning over a decade-and-a-half in which he has worked in diverse industries such as oil and energy, construction, consulting, FMCG, and agribusiness. Having worked with leading brands like Olam and KPMG, Rahul brings with him professionalism of the highest standards and hence, he is a revered leader at Gruner Renewables.
    ...
    <h1 className='biographyheader2'>Rahul has a specific skill set into providing services, such as:-</h1>
    <ol  className='biographyheader2'>
      <li>New business set up and/on geographical expansion</li>
      <li> Virtual CFO services to SME / STARTUPS/ENTREPRENEUR.</li>
      <li>Fund/Treasury/Banking Management</li>
      <li>Managing Investments into Real Estate , Startups , Bonds , Forex , Crypto & Commodities. </li>
      <li>Risk & Compliance support.</li>
    </ol>
    <p  className='biographyheader2'>He has handled operations across different geographies that include the Middle East, Asia, the Americas, and Africa. Over the years, Rahul has earned a good reputation for his strong work ethic and astute governess. He has built a strong network which he leverages to drive business for the company.</p>

  <p  className='biographyheader2'>As the Co-Founder and Head of International Sales at Gruner Renewables, Rahul brings a wealth of experience and expertise in business strategy, financial management, and global operations to the company.</p>
</div>
    </div>
</div>
  {/* code end from here  */}

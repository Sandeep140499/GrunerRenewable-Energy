...
export async function getServerSideProps() {
  const [operationsRes,whatsappRes] = await Promise.all([
    fetch(`https://whale-app-56hrz.ondigitalocean.app/api/contact-uses/?populate=*`),
  ...
  const [operations,whatsapp] = await Promise.all([
    operationsRes.json(),
    whatsappRes.json()
    // ratingRes.json()
  ]);
  return { props: { operations,whatsapp} };
}
export default function Home({operations,whatsapp}) {
...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/contactUs');
          ...
          <div className="container-fluid navbar ">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-1 mb-lg-0">
                ...
                {/* <li className="nav-item ">
                  <a className="nav-link navbarOne " aria-current="page" href="/our-products">
                    Our Products
                  </a>
                </li>
                <li className="nav-item ">
...
{/* <div className="hide">1234567890</div> */}
  ...
  <div className="container-fluid p-0 pt-5">
    <section id='contact_section' className="d-flex align-items-center ">
      <div className="container ">
        <h1 className="pb-lg-3 contact_heading">Contact Us</h1>
        <p className="contact_paragraph">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting.</p>
      </div>
    </section>
  </div>
  ...
  <div className="container pb-5 ">
    <div className="row">
      <div className="col-sm-6 col-md-7 pt-3 my-5 p-0">
        <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/map.png" className alt="..." />
      </div>
      <div className="col-12 col-lg-5 p-lg-5 pb-5 contactusackgroundcolor">
      <div class="row g-0 my-5">
  <div class="col-2 col-md-2">
  <img className="chatpng" src="https://gremedia.sgp1.digitaloceanspaces.com/media/location.jpg" alt="Generic placeholder image" />
  </div>
  <div class="col-10 col-md-10 pt-3 ml-3">
    
  <span className="getcotact">{row?.attributes.our_office}</span>
  </div>
</div>
<div class="row g-0 my-5">
  <div class="col-2 col-md-2">
  <img className="chatpng" src="https://gremedia.sgp1.digitaloceanspaces.com/media/email.jpg" alt="Generic placeholder image" />
  </div>
  <div class="col-10 col-md-10 pt-3 ml-3">
    
  <span className="getcotact">{row?.attributes.email_address}</span>
  </div>
</div>
<div class="row g-0 ">
  <div class="col-2 col-md-2">
  <img className="chatpng" src="https://gremedia.sgp1.digitaloceanspaces.com/media/phone.jpg" alt="Generic placeholder image" />
  </div>
  <div class="col-10 col-md-10 pt-3 ml-3">
    
  <span className="getcotact">
  {row?.attributes.contact_number}</span>
  </div>
</div>
      </div>
    </div>

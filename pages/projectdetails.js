...
const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
  ...
  if(res.data){
      alert("Form Saved Successfully.");
       router.push('https://grunerrenewable.com/projectdetails');
 ...
 <div className="container-fluid" id="flex-conatiner1">
  ...
  <div className="container text-center mt-4">
    <div className="">
      <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/projectdetailframe2.jpg" alt className='img-fluid'/>
    </div>
    </div>
    {/* over-view start here */}
    <div className=" text-start mb-2 projectdetailsfrompage">
      <div className="row ">
        <div className="col-12 col-lg-7 mt-5 projectdetailspadding ">
          <span className="overviewspan p-lg-2">OVERVIEW</span>
          <h3 className="headingoverview my-3">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley...</h3>
        ...
        <div className="col-sm-12 col-lg-5 col-12 project-details-from p-lg-5 ">
          <div className="row g-3 align-items-start my-3">
            <div className="col-auto ">
              <label htmlFor="Client" className="placeholderdetails">Client</label>
            </div>
            <div className="col-auto">
            <p className='clientdetails colorfordetailspage'>Lorem Ipsum</p>
            </div>
          </div> 
          <div className="row g-3 align-items-center my-auto">
            ...
            <div className="col-auto">
            <p className='pt-lg-3 clientdetails colorfordetailspage'>A-3, Sector 58
...
Noida, Uttar Pradesh,<br/>
 201301</p>
          ...
          <div className="row g-3 align-items-center my-3">
            ...
            <div className="col-auto">
            <p className='pt-lg-3 clientdetails colorfordetailspage'>2021 - 22</p>
            </div>
          </div> 
          <div className="row g-3 align-items-center my-3">
            <div className="col-auto">
            ...
            <div className="col-auto">
            <p className='pt-lg-3 clientdetails colorfordetailspage'>Lorem Ipsum</p>
            </div>
          </div> 
          <div className="row g-3 align-items-center my-3">
            <div className="col-auto">

...
{/* <div className="hide">1234567890</div> */}
  ...
  <div class="container p-0">
    ...
    <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/f1896e22994180af990a88b4a48e21fb.jpg" class="img-fluid" alt="..."/>
</div>
  <div class="col-12 col-lg-9 p-3 pt-lg-5 text-center">
  <h1 className=' biopageheader'>Mr. Asit Chatterjee</h1>
    <h2 className='pt-lg-3 biographyheader2'>(President)</h2>
</div>
<div class="col-lg-12 col-12  p-3 biographylorem">
<p>
Mr. Asit Chatterjee is associated with Gruner Renewable Energy in the capacity of President. He has a masters in Civil Engineering and MBA in Business Operations Management. He has a rich experience in various infrastructure sectors like railways, metros, roads, hospitals, stadiums, commercial & residential buildings etc. over 30 years. Earlier he also worked with M/s Punj Lloyd & Simplex in top management capacity. 
</p>

    <p  className='biographyheader2'></p>

  <p  className='biographyheader2'>
</p>

...
export async function getServerSideProps() {
  const [operationsRes,logoRes,teamRes,whatsappRes] = await Promise.all([
    fetch(`https://whale-app-56hrz.ondigitalocean.app/api/about-uses/?populate=*`),
  ...
  const [operations,logos,team,whatsapp] = await Promise.all([
    operationsRes.json(),
    logoRes.json(),
    teamRes.json(),
    whatsappRes.json()
  ]);
  return { props: { operations,logos,team,whatsapp} };
}

export default function Home({operations,logos,team,whatsapp}) {
  ...
  const onSubmit = async ({ full_name, company_name, email, contact_us, message }) => {
    ...
    if(res.data){
        alert("Form Saved Successfully.");
         router.push('https://grunerrenewable.com/about');
  ...
  return (
    <>
      ...
      <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css"></link>
        ...
        <meta name="description" content="Grener Renewable Energy" />
...
{/* <div className="hide">1234567890</div> */}
  ...
  <section id="hero" className="d-flex align-items-center">
    <div className="container">
      <h1 className="pb-lg-3">{row?.attributes.banner_title}</h1>
      <ReactMarkdown className="hero-about-paragraph">
      {row?.attributes.banner_description}
      </ReactMarkdown>
    </div>
  </section>
    ))}
  {operations.data?.map( (row) => (
  <div className="container-fluid" id="frame-2">
    <div className="row pt-lg-5">
      <div className="col-12 col-lg-4 my-auto mx-auto p-lg-5">
        <h1 className="heading-frame-third ">
       {row?.attributes.about_left_title}
        </h1>
        <br />
        <ReactMarkdown className="pt-3">
          {row?.attributes.about_left_desription}
        </ReactMarkdown>
      </div>
      <div className="col-12 col-lg-5">
        <img
          src={ row?.attributes.about_image.data[0].attributes.url}
          className="img-fluid"
          alt="..."
          id=""
        />
      </div>
      <div className="col-12 col-lg-3 my-auto mx-auto p-lg-3" id="text">
      <ReactMarkdown>
        {row?.attributes.about_right_desription}
        </ReactMarkdown> 
          ...
          <div className="col-12 ">
            <div className="pt-3">
              <i className="bi bi-check2-circle" id="sign">
                &nbsp;
                <span id="kuchbhidedo">{row?.attributes.about_right_bottom1}</span>
              </i>
            </div>
          </div>
          <div className="col-12">
            <div className="pt-3">
              <i className="bi bi-check2-circle" id="sign">
                {" "}
                &nbsp;
                <span id="kuchbhidedo">{row?.attributes.about_right_bottom2}</span>
              </i>
            </div>
          </div>
          <div className="col-12">
            <div className="pt-3">
              <i className="bi bi-check2-circle" id="sign">
                {" "}
                &nbsp;
                <span id="kuchbhidedo">{row?.attributes.about_right_bottom3}</span>
              </i>
            </div>
          </div>
          <div className="col-12">
            <div className="pt-3">
              <i className="bi bi-check2-circle" id="sign">
                {" "}
                &nbsp;
                <span id="kuchbhidedo">{row?.attributes.about_right_bottom4}</span>
              </i>
            </div>
          </div>
        </div>
  ...
  <div className="container-fluid pt-lg-5">
    <div className="row">
      <div className="col-lg-5 col-12 my-auto g-0">
        <div className="mission-main p-lg-5 p-5">
          <span className="mission p-lg-3 p-3">OUR MISSION</span>
          <ReactMarkdown className="pt-lg-5 pt-5">
            {row?.attributes.mission_desription}
            </ReactMarkdown>
        </div>
      </div>
      <div className="col-lg-7 col-12 px-0 text-end imgshow">
        <img src={ row?.attributes.mission_image.data[0].attributes.url} className="img-fluid" alt="..." />
      </div>
    </div>
  </div>
  ))}
  ...
  <div className="container-fluid pt-lg-5">
    <div className="row">
      <div className="col-lg-7 col-12 px-0 text-start">
        <img src={ row?.attributes.vision_image.data[0].attributes.url} className="img-fluid" alt="..." />
      </div>
      <div className="col-lg-5 col-12 my-auto g-0">
        <div className="vision-main p-lg-5 p-5">
          <span className="mission p-lg-3 p-3">OUR VISION</span>
          <ReactMarkdown className="pt-lg-5 pt-5">
            {row?.attributes.vision_desription}
            </ReactMarkdown>
        </div>
      </div>
    </div>
  ...
  {operations.data?.map( (row) => (
  <div className="conatiner mt-lg-5 pb-5">
    <div className="row">
      <div className="col-12 col-lg-4 offset-lg-1 our-values-section pt-4 p-5">
        <div className='pt-lg-5'>
          <span className="mission p-lg-3 p-3">OUR VALUES</span>
        </div>
        {/* <h1 className="mx-auto pt-3 ourtextheading">OUR VALUES</h1> */}
        <ReactMarkdown className="pt-lg-5 pt-5 fontlorem">
          {row?.attributes.our_values_desription}
          </ReactMarkdown>
      ...
      <div className="col-12 col-lg-6">
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            >
              <div className="container lftryt">
              <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle 151.png" className="" alt="" />
                <h6>Sustainability</h6>
                <ReactMarkdown className='aboutuspagelorempara'>
                  {row?.attributes.our_right_desription1}
                  </ReactMarkdown>
              </div>
            </section>
          </div>
          <div className="col-lg-6 ryt-below-abt">
            <section
              id="section-loyality"
              className="d-flex align-items-center"
            >
              <div className="container lftryt">
              <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/innovation.png" className="" alt="" />
                <h6>Innovation</h6>
                <ReactMarkdown className='aboutuspagelorempara'>
                  {row?.attributes.our_values_desription2}
                  </ReactMarkdown>
              </div>
            </section>
          </div>
          <div className="col-lg-6">
            ...
            >
              <div className="container lftryt">
              <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/innovation1.png" className="" alt="" />
                <h6>Social Responsibility</h6>
                <ReactMarkdown className='aboutuspagelorempara'>
                  {row?.attributes.our_values_desription3}
                  </ReactMarkdown>
              </div>
            </section>
          </div>
          <div className="col-lg-6  ryt-below-abt">
            ...
            >
              <div className="container lftryt">
              <img src="https://gremedia.sgp1.digitaloceanspaces.com/media/innovation2.png" className="" alt="" />
                <h6>Collaboration</h6>
                <ReactMarkdown className='aboutuspagelorempara'>
                  {row?.attributes.our_values_desription4}
                  </ReactMarkdown>
              </div>
            </section>
          </div>
  ...
  {/* section how we funtionate start */}
  {operations.data?.map( (row) => (
  <div className="conatiner-fluid zero">
    <div className="container text-center">
      <div className="row g-2 funcationateSection">
        <div className=" col-12 col-lg-7">
          <div className="p-3 pt-lg-5">
            <span className="howwefunction p-lg-3 ">
              HOW WE FUNCTION
            </span>
            <h2 className="headingProvide pt-lg-5 pt-3">
            {row?.attributes.how_we_funetion_title}
            </h2>
          </div>
        </div>
        <div className=" col-lg-5 pt-lg-5 col-12">
          <div className="p-3">
            <span className="paragraph-lorem-function">
            {row?.attributes.how_we_funetion_desription}
            </span>
          </div>
        </div>
        <div className="col-12">
        <div class="row p-lg-4">
    <div class="col-12 col-lg-3 borderaboutus">
    <span className="ryticonimage"><img src="https://gremedia.sgp1.digitaloceanspaces.com/media/planning.png" /></span>
    <h1 className='aboutusloremheading' >   {row?.attributes.how_we_function_bottom_title1}</h1>
                <ReactMarkdown className='aboutusparagraph'> 
                  {row?.attributes.how_we_function_bottom_desrption1}
                  </ReactMarkdown>
    </div>
    <div class="col-12 col-lg-3  borderaboutus">
    <span className="ryticonimage"><img src="https://gremedia.sgp1.digitaloceanspaces.com/media/certified engg.png" /></span>
    <h1 className='aboutusloremheading'>   {row?.attributes.how_we_function_bottom_title2}</h1>
    <ReactMarkdown className='aboutusparagraph'> 
                  {row?.attributes.how_we_function_bottom_desrption2}
                  </ReactMarkdown>
    </div>
    <div class="col-12 col-lg-3 borderaboutus">
    <span className="ryticonimage"><img src="https://gremedia.sgp1.digitaloceanspaces.com/media/reliablity.png" /></span>
    <h1 className='aboutusloremheading'>   {row?.attributes.how_we_function_bottom_title3}</h1>
    <ReactMarkdown className='aboutusparagraph'> 
                  {row?.attributes.how_we_function_bottom_desrption3}
                  </ReactMarkdown>
    </div>
  </div>
        </div>
  ...
  {/* section how we funtionate end*/}
  {/* Sustainability section start */}
  <section className="conatiner-fluid Sustainability p-lg-5 ">
    <h1 className=" text-center Sustainabilitytext startpadding">
      Sustainability
    </h1>
    <div className="col-12 col-lg-12 text-center">
    <a href='/sustainability'>
            <button className="Sustainabilitybutton">
  ...
  {/* https://gremedia.sgp1.digitaloceanspaces.com/media PART  */}
  <div className="container p-0 ">
    {/* Carousel History */}
  </div>
  {/* four https://gremedia.sgp1.digitaloceanspaces.com/media section  end*/}
  {/* https://gremedia.sgp1.digitaloceanspaces.com/media PART STRAT */}
  <div className="container p-lg-4">
    <div className="row">
      <div className="col-12 col-lg-12 pt-lg-5 pt-5">
        <span className="mission p-lg-3 p-3">MEET OUR EXPERTS</span>
      </div>
      <div className="col-12 col-lg-12 mt-5 addYourTextHeading">
        <h1>
      ...
      <div className="col-12 col-lg-12 pt-3">
        <div className="row pb-5">
          <div className="row">
          {team.data?.map( (row) => (
            <div className="col-lg-3 col-12 pb-3 ">
              <div className="thumbnail">
                <a href={`/biography/${row?.attributes.Slug}`}>
                  <img
                     src={ row?.attributes.image_team.data[0].attributes.url}
                    alt=""
                    className='img-fluid'
                    style={{ width: "100%" }}
                  />
            ...
            {/* <div className="col-md-3">
              <div className="thumbnail">
                <a href="">
                  <img
                    src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle-144 (1).jpg"
                    alt="Nature"
                    className='img-fluid'
                    style={{ width: "100%" }}
                  />
            ...
            <div className="col-md-3">
              <div className="thumbnail">
                <a href="">
                  <img
                    src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle-144 (2).jpg"
                    alt="Fjords"
                    classname= "img-fluid"
                    style={{ width: "100%" }}
                  />
            ...
            <div className="col-md-3">
              <div className="thumbnail">
                <a href="">
                  <img
                src="https://gremedia.sgp1.digitaloceanspaces.com/media/Rectangle-144 (3).jpg"
                    alt="Fjords"
                    className='img-fluid'
                    style={{ width: "100%" }}
                  />
  ...
  {/* <div className="container pt-5 pb-5">
    ...
    {logos.data?.map( (row) => (
        <div className="col-4 col-lg-2"><img src={ row?.attributes.logo.data[0].attributes.url} className="img-fluid" alt srcSet /></div>
        ))}
    </div>
  </div> */}
